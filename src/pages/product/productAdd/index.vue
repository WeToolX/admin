    ...
    <el-card :bordered="false" shadow="never" class="mt16" :body-style="{ padding: '0 20px 20px' }">
      ...
      >
        ...
        <el-row :gutter="24" v-show="currentTab === '1'">
          ...
          <el-col :span="24">
            <el-form-item label="京东参考价链接：" prop="jd_url">
              <el-input class="content_width" v-model="formValidate.jd_url" placeholder="请输入京东参考价链接" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="品牌：" prop="brand">
              <el-input class="content_width" v-model="formValidate.brand" placeholder="请输入品牌" />
            </el-form-item>
          </el-col>
